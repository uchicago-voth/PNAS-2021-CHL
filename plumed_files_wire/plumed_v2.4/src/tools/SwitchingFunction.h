...
/// This is to indicate whether deriv needs division
  bool do_division;
/// Type of function
  enum {rational,exponential,gaussian,smap,cubic,tanh,matheval,nativeq,
     step,modulated_exponential,polynomial3,polynomial3_plateau,constant} type;
...
/// Cutoffs
  double r1, r2;
/// Coeffs in the polynomial
  double a3, a2, a1, a0;
/// Whether to do truncation
  bool do_trunc;
public:
...
/// Set the d0 parameter
  void set_d0(double d_0);
...
/// If divided
  bool divided() const {return do_division;}
};
